 ...
 */
public class BlackJackViewModel implements PropertyChangeListener{
    
    private final BlackJackModel mo;
    ...
    public BlackJackViewModel(BlackJackModel mo) {
        this.mo = mo;
    }
...
//        mo.checkPlayer(sumP,sumG,creditPut,creditNow);
//    }
